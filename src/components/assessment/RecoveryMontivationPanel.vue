<template>
    <div class="onboarding-panel">
      ...
      <div class="content-wrapper" ref="contentWrapper">
        <div class="panel-content" ref="contentPanel">
          ...
          <h2 class="panel-title">What helps you stay on track during recovery?</h2>
          ...
          <v-fade-transition>
            <div class="options-container">
              <v-btn
                ...
                variant="outlined"
                color="white"
                class="motivation-option mb-3"
                :class="{ 'selected': selectedMotivation === option.value }"
                @click="selectMotivation(option.value)"
              >
  ...
  const motivationOptions = [
    {
      value: 'structure',
      label: 'Give me structure and a plan',
      icon: 'mdi-calendar-check-outline'
    },
    {
      value: 'progress',
      label: 'Show me daily progress',
      icon: 'mdi-chart-line'
    },
    {
      value: 'reminders',
      label: 'Gentle reminders keep me going',
      icon: 'mdi-bell-outline'
    }
  ];
  
  const isValid = computed(() => {
    return selectedMotivation.value !== null;
  });
  ...
  const selectMotivation = (value) => {
    selectedMotivation.value = value;
  ...
  const next = () => {
    if (isValid.value) {
      const data = {
        recoveryMotivation: selectedMotivation.value
      };
